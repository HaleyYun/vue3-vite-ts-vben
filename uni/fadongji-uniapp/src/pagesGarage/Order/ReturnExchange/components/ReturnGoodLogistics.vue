<template>
  <view class="block">
    ...
    <EraRadioGroup v-model="radioValue" class="block-info" placement="column">
      <EraRadio
    ...
    <view class="block-info__proof">发货凭证：</view>
      ...
      <view class="block-info__Logistics">
        <view class="flex flex-vertical-c flex-justify-between m-b-16">
          <view class="color-block">
            <text class="color-red m-r-4">*</text>
            运单号：
          </view>
          <view class="color-block flex flex-vertical-c">
            ...
            <image class="scan-class" src="/static/icons/scan.png" @click="scanOcrFn"></image>
          </view>
        </view>
        <view class="flex flex-vertical-c flex-justify-between m-b-16">
          <view class="color-block">
...
<script>
  ...
  export default {
    ...
    watch: {
      logisticsList(val) {
        console.log('logisticsList', val[0].src)
