<template>
  <view>
    <image :src="filePath" v-if="filePath" class="logo-bg flex flex-vertical-c flex-justify-c" @click="chooseImgFn">
    </image>
    <view v-else class="logo-bg flex flex-vertical-c flex-justify-c" @click="chooseImgFn">
      <image class="logo-bg__icon" src="/static/created/certify/camera.png" />
    </view>
  </view>
</template>
