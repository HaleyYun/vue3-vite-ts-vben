    ...
    >
      <view class="bottom flex flex-column">
        <view class="flex flex-row flex-vertical-c flex-justify-between p-t-24">
          ...
          <VoIcon :opacity="0.45" :size="16" color="#000" name="close-x" @click="close" />
        </view>
        <view class="bottom-line m-t-24" />
        <view class="flex flex-row flex-vertical-c m-t-24">
          <view class="bottom-text1">供修理厂名称：</view>
        ...
        <view :style="{ opacity: isNoPass ? 1 : 0 }">
