<template>
  ...
  >
    ...
    <!-- <VoIcon
      ...
      color="#333333"
    />
    <VoIcon v-if="!isChecked" class="u-checkbox__icon-wrap__icon" name="left-arrow" /> -->
    <text
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      elIconColor() {
        ...
        if (this.elDisabled) {
          ...
          return this.isChecked ? this.elInactiveColor : '#fff'
        } else {
          return this.isChecked ? iconColor : '#fff'
        }
      },
      iconClasses() {
        let classes = []
    ...
    methods: {
      ...
      updateParentData() {
        this.getParentData('EraCheckboxGroup')
      },
...
<style lang="scss" scoped>
  ...
  $u-checkbox-icon-wrap-border-color: rgba(0, 0, 0, 0.15) !default;
  ...
  $u-checkbox-icon-wrap-checked-border-color: #22284b !default;
  $u-checkbox-icon-wrap-disabled-background-color: rgba(0, 0, 0, 0.08) !default;
  $u-checkbox-icon-wrap-disabled-border-color: rgba(0, 0, 0, 0.15);
