<template>
  <view class="u-form-item">
    ...
    <EraLine
      v-if="borderBottom"
      :color="
        message && parentData.errorType === 'border-bottom' ? $u.color.error : propsLine.color
      "
      :customStyle="`margin-left:30rpx;margin-top: ${
        message && parentData.errorType === 'message' ? '10px' : 0
      }`"
    ></EraLine>
  </view>
</template>
