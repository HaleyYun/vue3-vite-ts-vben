<template>
  <view :class="textareaClass" :style="[textareaStyle]" class="u-textarea">
    <textarea
      ...
      :style="{ height: $u.addUnit(height), color: textColor }"
      :value="innerValue"
    ...
    <text v-if="count" :style="countStyle" class="u-textarea__count"
