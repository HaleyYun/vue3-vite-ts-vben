<template>
  <view class="search">
    ...
    >
      ...
      <!--  左右可滑动区域  -->
      <view class="shop-slide" v-if="isLoad">
        <view class="tab-nav">
          <EraTabs
            :current="current"
            :list="tabsList"
  ...
  export default {
    ...
    methods: {
      ...
      openEdit() {
        ...
        //新业务 跳转去新页面修改
        this.$linkToEasy(
          '/pagesAgent/VinTell/UpdateVin?imageInfoVO=' + this.imageInfoVO + '&code=' + this.code,
        )
      },
      /**
       * 确认事件
      ...
      async queryListData(init, first) {
        ...
        try {
          ...
          const res = await this.$VoHttp.GOODS.apiGoodsProjectInvestmentSpList({
            ...this.pageQuery,
            ...params,
            sourceType: 1,
