<template>
  ...
  >
    <VoNav :is-fixed="false" isHaveMore title="商品人气榜" />
    <vo-statistical-time :showTab="false" :top="82" :statustiCalDate="statustiCalDate" @timeConfirm="timeConfirm" />
    <!--商品人气榜-->
    <view class="background">
      <commodities-list :timeParams="timeParams" :selectOptions="selectCurrent" :isMore="false" />
    </view>
  </view>
</template>
...
<script>
  ...
  import CommoditiesList from '@/components/VoStatistical/component/CommoditiesList'
  export default {
    name: 'AgentCommodityPopularityList',
    components: { CommoditiesList, VoStatisticalTime },
    data() {
      return {
