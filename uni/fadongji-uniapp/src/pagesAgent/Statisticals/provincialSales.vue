<template>
  ...
  >
    <VoNav :is-fixed="false" isHaveMore title="同省销量排名" />
    <vo-statistical-time :top="82" :statustiCalDate="statustiCalDate" @timeConfirm="timeConfirm" />
    <!--订单支付明细-->
    <view class="background">
      <province-sales-ranking :timeParams="timeParams" :isMore="false" />
    </view>
  </view>
</template>
...
<script>
  ...
  import ProvinceSalesRanking from '../../components/VoStatistical/component/ProvinceSalesRanking'
  export default {
    name: 'ProvincialSalesList',
    components: { ProvinceSalesRanking, VoStatisticalTime },
    data() {
      return {
