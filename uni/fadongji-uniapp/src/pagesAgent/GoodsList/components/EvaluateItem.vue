<template>
  <view class="evaluateItem">
    <view class="flex">
      <image class="evaluateItem-icon" :src="evaluateData.photoUrl" />
   ...
   <block v-if="evaluateData.mainContent.content||(evaluateData && evaluateData.mainContent && evaluateData.mainContent.imgArr && evaluateData.mainContent.imgArr.length)">
     <view class="evaluateItem-content">{{ evaluateData.mainContent.content }}</view>
     <view v-show="evaluateData && evaluateData.mainContent && evaluateData.mainContent.imgArr && evaluateData.mainContent.imgArr.length" class="evaluateItem-photo">
       <VoFormUpload :source.sync="evaluateData.mainContent.imgArr" readonly preview />
     </view>
