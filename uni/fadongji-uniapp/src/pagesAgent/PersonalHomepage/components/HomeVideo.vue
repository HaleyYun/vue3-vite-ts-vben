          ...
          <view class="list-item__main">
            ...
            <view class="flex-line">
              <!-- <view class="flex-line__photo">
                <image :src="item.photoUrl || '/static/default_avatar.png'" class="ava-img" />
                <VoIcon
              ...
              <view class="name-text">
                ...
                {{ $vocenApi.dayjs(item.createTime).format('YYYY年MM月DD日') }}
              </view>
  ...
  export default {
    ...
    methods: {
      ...
      toPage(item, index) {
        ...
        this.$linkToEasy(
          `/pagesAgent/CreatedCenter/CreatedVideoList/VideoSwiper?id=${item.id}
            &index=${index}&pageSize=${this.pageSize}&pageNo=${this.pageNo}&isEdit=${isEdit}&columnId=${this.columnId}&disableTouch=${disableTouch}`,
        )
        // #endif
        // #ifdef APP-PLUS
        this.$linkToEasy(
      ...
      imgErr(item) {
        ...
        item.videoPoster = '/static/logo.jpg'
      },
    },
  }
</script>
...
<style lang="scss" scoped>
  .video-list {
    ...
    &__list {
      ...
      column-gap: 18upx;
      padding: 16upx 32upx 32upx 32upx;
