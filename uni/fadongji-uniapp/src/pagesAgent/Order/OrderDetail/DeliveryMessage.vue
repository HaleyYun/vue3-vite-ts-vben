<template>
  ...
  >
    ...
    >
    <view v-for="(delivery, index) in deliverListInfo" :key="index" class="m-b-32">
      <!--无需物流-->
      <view v-if="delivery.deliveryType === '无需物流' || delivery.deliveryType === ''">
        ...
        <view class="delivery-info m-t-2">
          <!--识别码-->
          ...
          <view class="m-t-4">
            <scroll-view class="scroll" scroll-y="true">
              <view class="code">
                <view
                  v-for="(item, index) in delivery.engineNoList"
                  :key="index"
                  class="flex flex-vertical-c"
                >
                  <view class="code-title">{{ item }}</view>
                  <view class="fz-28 color-blue" @click.stop="copyClick(item)">复制</view>
                </view>
              </view>
            </scroll-view>
          </view>
        ...
        <view class="delivery-info m-t-2">
          <view class="delivery-info__good">
            ...
            <!-- :engineNo="delivery.engineNoList[index] || ''" -->
            <OrderGoodItem
  ...
  export default {
    ...
    methods: {
      ...
      marketGetDeliverDetailRequest() {
        let param = { id: this.orderDetail.id }
        this.$VoHttp
