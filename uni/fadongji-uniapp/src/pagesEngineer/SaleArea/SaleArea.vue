<template>
  ...
  >
    <VoNav :is-fixed="false" is-have-more title="服务区域" />
    <view class="border-bold">
      <view class="setting-title flex flex-justify-between">
        <view>当前位置</view>
        <view class="fz-24 font-weight-500 flex flex-vertical-c">
          当前定位：{{ currentCity }}
      ...
      <view class="btn fz-24 p-t-18 p-b-14">
        <view
          ...
          :key="key"
          :class="{ isActive: item.value === currentTag.value }"
          calss="btn_item"
          @click="locChoose(item)"
          >{{ item.label }}
        </view>
      </view>
    </view>
    <view class="color-block fz-30 p-l-32 p-b-24">更多区域</view>
          ...
          <view :class="{ 'left-active': i === tabOneIndex }" class="left-item">
            <view class="flex flex-vertical-c">
              ...
              <!-- <VoIcon
                ...
                @click="tabOneCheckHandler(p, i)"
              /> -->
              <!-- <VoIcon v-if="false" :size="28" color="#5F616E" name="select-right" /> -->
              <view
        ...
        <view id="collapse">
          <view class="u-collapse-content fz-0 p-l-24 p-r-24 border-box">
            ...
            <view class="flex flex-vertical-c m-b-20" @click.stop>
              <!-- <template v-if="selectKey.includes(cityChoose.code)"> -->
              <VoIcon
              ...
              <VoIcon
                ...
                color="#D9D9D9"
                name="circle"
                @click="tabTwoCheckHandler(cityChoose, cityChooseIndex)"
              /> -->
