    ...
    <view class="notcertified-info flex1 flex flex-row">
      ...
      <view class="flex1 sflex flex-column">
        ...
        >
          ...
          <view
            v-else-if="info.checkStatus === 2 && info.isBindMobile"
          ...
          <view
            ...
            class="green status flex flex-row flex-vertical-c"
          >
          ...
          <view v-else-if="info.checkStatus === 5" class="status flex flex-row flex-vertical-c red">
            <VoIcon color="#EE0A24" name="pending-review" size="12" />
            <view class="status-text4">审核拒绝</view>
          </view>
          <view v-if="info.checkStatus === 7" class="mobile-status1 m-l-8">待绑定手机</view>
          <view v-else-if="info.checkStatus === 1" class="mobile-status3 m-l-8">通联审核中</view>
          <view v-else-if="info.checkStatus === 3" class="mobile-status2 m-l-8">通联审核失败</view>
          <view v-else-if="info.isBlacklist" class="mobile-status2 m-l-8">黑名单</view>
          <!--          <VoIcon-->
