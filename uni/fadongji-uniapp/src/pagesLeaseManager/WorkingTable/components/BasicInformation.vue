<template>
  <view class="basic">
    ...
    <view class="basic-outlets">
      ...
      <image :src="information.businessLicenseUrl" class="basic-outlets__img" @click="previewImg(information.businessLicenseUrl)" />
    </view>
    ...
    <view class="basic-outlets m-t-16">
      ...
      <view class="flex flex-justify-between">
        <image :src="information.legalIdCardFront" class="basic-outlets__img2" @click="previewImg(information.legalIdCardFront)" />
        <image :src="information.legalIdCardBack" class="basic-outlets__img2" @click="previewImg(information.legalIdCardBack)" />
      </view>
    </view>
    <view class="basic-list lh48 fz-32 color-block">
      <view class="basic-list__item">
    ...
    <!--  经营品牌  -->
    <template v-if="information.certificationBrand && information.certificationBrand.length > 0">
      <view class="basic-outlets m-t-16">
