  ...
  <view class="user">
    ...
    <view class="page-container">
      <view class="user-nav" @click.stop="userCentre">
        ...
        <view class="flex border-box overflow-hidden">
          ...
          <view class="base-info overflow-hidden">
            <view class="base-info__nickname overflow-ellipsis">
      ...
      <EraCell
        ...
        @click="nextPage(item)"
      >
        <VoIcon slot="icon" :name="item.iconName" color="#373A4E" size="20" />
      </EraCell>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        ...
        settingList: [
          {
            name: '我的订单',
            path: '/pagesOldBuyer/MyOrder/MarkerOrderList',
            iconName: 'contract',
          },
          {
            name: '个人中心',
    ...
    methods: {
      ...
      userCentre() {
        this.$linkToEasy('/pagesOldBuyer/UserCenter/UserCenter')
      },
      reachBottom() {
        console.log('触底')
      },
