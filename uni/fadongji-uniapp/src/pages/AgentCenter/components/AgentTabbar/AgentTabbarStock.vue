<template>
  <view class="stock">
    <VoStatistical @updatepops="showPop" />
    <!--  底部悬浮start  -->
    <view
      v-if="
...
<script>
  // import GoodsAdapter from '@/pagesAgent/GoodManagement/components/GoodsAdapter'

  import { linkToEasy } from '@/common/helper'
  import store from '@/store'
  import VoStatistical from '@/components/VoStatistical/VoStatistical'

  export default {
    name: 'AgentTabbarStock',
    components: { VoStatistical },
    // components: { GoodsAdapter },
    props: {},
    data() {
      return {
        currentUserFullInfo: {},
