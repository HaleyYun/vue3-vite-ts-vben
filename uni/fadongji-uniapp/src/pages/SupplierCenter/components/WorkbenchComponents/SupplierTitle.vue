<template>
  <view class="title flex flex-vertical-c flex-justify-between">
    <image class="title-img" src="/static/supplier/home/slogan_supplier.png" />
    <view class="flex flex-vertical-c">
      <view class="title-switch flex flex-vertical-c flex-justify-c">
        <VoTooltip
          :arrowStyleSelf="{ left: '134rpx' }"
      ...
      >
        ...
        <VoBadge v-if="count" :value="count" class="title-news__badge" max="99" />
      </view>
    </view>
  </view>
</template>
