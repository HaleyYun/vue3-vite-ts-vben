  ...
  <view class="uni-calendar">
    ...
    >
      ...
      <view class="uni-calendar__header">
        <view class="icon-wrap" @click.stop="preYear">
          <VoIcon name="left-double-arrow" :size="20" color="#000000" :opacity="0.85" />
        </view>
        <view style="height: 40rpx" @click.stop="pre">
          <VoIcon name="left-arrow" :size="20" color="#000000" :opacity="0.65" />
        </view>
        ...
        <view style="height: 40rpx" @click.stop="next">
          <VoIcon name="right-arrow" :size="20" color="#000000" :opacity="0.65" />
        </view>
        <view class="icon-wrap right" @click.stop="nextYear">
          <VoIcon name="left-right-arrow" :size="20" color="#000000" :opacity="0.85" />
        </view>
      ...
      <view class="uni-calendar__box">
        ...
        <view class="uni-calendar__weeks week">
...
<script>
  ...
  import calendarItem from './VoCalendarItem.vue'
  ...
  export default {
    ...
    emits: ['close', 'confirm', 'change', 'monthSwitch', 'yearSwitch'],
    data() {
      return {
        show: false,
        weeks: [],
