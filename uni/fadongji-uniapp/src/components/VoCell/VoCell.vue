  ...
  >
    ...
    >
      <view class="u-cell__body__content">
        ...
        <view v-if="$slots.image || image" class="u-cell__left-icon-wrap">
      ...
      <slot name="value">
        <text
          ...
          >{{ value }}</text
        >
        <VoBadge v-if="badgeDot" :isDot="true" class="u-cell__title-badge" />
      </slot>
      <view
    ...
    <view class="m-l-32 m-r-32"><u-line v-if="border" color="rgba(0, 0, 0, 0.08)"></u-line></view>
  </view>
</template>
...
<style lang="scss" scoped>
  $u-cell-padding: 24rpx 32rpx !default;
  $u-cell-font-size: 32rpx !default;
  $u-cell-line-height: 24px !default;
  $u-cell-color: $u-main-color !default;
  $u-cell-icon-size: 16px !default;
  $u-cell-title-font-size: 32rpx !default;
  $u-cell-title-line-height: 48rpx !default;
  $u-cell-title-color: $v-c0-85 !default;
  $u-cell-label-font-size: 12px !default;
  $u-cell-label-color: $u-tips-color !default;
  $u-cell-label-line-height: 18px !default;
  $u-cell-value-font-size: 32rpx !default;
  $u-cell-value-color: $v-c0-25 !default;
