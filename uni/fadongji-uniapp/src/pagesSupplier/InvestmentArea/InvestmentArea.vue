<template>
  ...
  >
    ...
    <view
      ...
      class="left-item flex flex-justify-between flex-vertical-c global-area"
    >
      <view
        class="flex flex-vertical-c lh-100 p-l-10"
        @click="chooseAll(!selectKey.includes('86'))"
      >
        ...
        <view v-if="selectKey.includes('86')" class="m-l-5 fz-28 lh-100 text-color"> 全国</view>
        <view v-else class="m-l-5 fz-28 lh-100 color-block-45"> 全国</view>
      </view>
    </view>
      ...
      <scroll-view :scroll-y="true" class="brand-content__left">
        ...
        >
          <view class="flex flex-vertical-c">
            <block v-if="selectKey.includes(p.code)">
              <VoIcon
            ...
            >
              <view slot="title">
                <view class="flex flex-vertical-c" @click.stop>
                  <block v-if="selectKey.includes(c.code)">
                    <VoIcon
              ...
              <view class="u-collapse-content fz-0">
                <view class="flex right-list flex-wrap">
                  ...
                  >
                    <view class="right-item--inner overEllipsis">{{ t.name }}</view>
                  </view>
                </view>
              </view>
              <block slot="value">
    ...
    <view v-if="!preview" class="p-b-safe-area">
      <view class="flex py-20 flex-vertical-c flex-justify-around">
        <view class="bottom-btn1" @click="resetHandler"> 重置 </view>
        <view class="bottom-btn2" @click="confirmHandler">确定</view>
      </view>
    </view>
...
<script>
  export default {
    ...
    onLoad(options) {
      ...
      console.log(defaultArea, 'xx', this.$storage.get('defaultArea'))
