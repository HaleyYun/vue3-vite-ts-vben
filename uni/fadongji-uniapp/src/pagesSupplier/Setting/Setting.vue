  ...
  <view>
    ...
    >
      ...
      <view class="setting-content flex1 overflow-y">
        ...
        <EraCell
          v-if="currentUserFullInfo.platformCode != 'oldMachine'"
          :border="false"
          title="工作台设置"
          url="/pagesSupplier/Setting/WorkbenchSeting"
        >
          <block slot="value">
            <VoIcon :opacity="0.45" :size="20" color="#000000" name="arrow-right" />
          </block>
        ...
        <!--        </block>-->
        <block v-if="currentUserFullInfo.platformCode == 'oldMachine'">
        ...
        <!-- #endif -->
        <EraCell
          :border="userInfo.roleCode === 'supplier'"
          title="关于我们"
          url="/pagesSupplier/Setting/AboutUS"
        >
          <block slot="value">
            <VoIcon :opacity="0.45" :size="20" color="#000000" name="arrow-right" />
          </block>
