<template>
  <view>
    <view
      ...
      class="fz-32 cell-list-title m-r-32 flex flex-justify-between"
    >
      <text>进货人</text>
      <view class="fz-26 color-block-65 flex" @click="toDetail">
        查看更多<VoIcon :opacity="0.65" :size="16" color="#000000" name="right-arrow" />
      </view>
    </view>
    <view
    ...
    >
      <image
        ...
        class="m-t-24 investing-list__img"
      />
      <view class="m-l-16 flex1">
        ...
        >
          ...
          <view
            ...
            :class="
              +item.orderStatus === 1230 || +item.orderStatus === 1240 ? 'investing-list__button1' : 'investing-list__button2'
            "
