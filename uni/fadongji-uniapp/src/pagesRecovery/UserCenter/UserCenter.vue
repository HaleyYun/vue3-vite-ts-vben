    ...
    <VoCellGroup :border="false">
      ...
      <!-- <VoCell title="回收公司合作合同">
        <view slot="value" class="flex flex-vertical-c supplier-tag">
          ...
          <view>{{ formData.signContract === true ? '已签订' : '未签订' }}</view>
        </view>
        <VoIcon
      ...
      <VoCell title="认证信息" @click="goApproveInfo">
        <view slot="value" class="flex flex-vertical-c supplier-tag color-5ED697">
      ...
      <VoCell title="我的银行卡" url="/pagesSupplier/UserCenter/MyBankCard">
