<template>
  <view v-if="info.id" class="modify">
    <u-popup :round="10" :show="show" closeable mode="bottom" @close="close">
      ...
      <view class="modify-bottom flex flex-justify-between p-b-safe-area">
        ...
        <block v-else>
          <EraButton circle size="small" text="取消" themeType="Wire" @click="cancel" />
