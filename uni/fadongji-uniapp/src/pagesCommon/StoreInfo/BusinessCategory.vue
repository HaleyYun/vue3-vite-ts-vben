<template>
  ...
  >
    <VoNav :left-width="220" :right-width="220" is-fixed is-have-more title="经营品类">
      <template #operation>
        <view class="business-complete disable m-r-24" @click="goApplyRecord">申请记录</view>
      </template>
    </VoNav>
    ...
    <view class="business-bottom">
      <EraButton circle font-size="32rpx" text="认证新品类" @click="goCertifiedCategory" />
...
<script>
  ...
  export default {
    ...
    methods: {
       ...
       */
      goApplyRecord() {
        this.$linkToEasy('/pagesCommon/StoreInfo/ApplyRecord')
      },
      /**
       * 去认证新品类
       */
