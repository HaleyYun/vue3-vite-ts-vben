<template>
  ...
  <script setup lang="ts">
    ...
    import { filterFormSchemas } from '/@/modules/ContentModule/view/CircleManage/AnswerManage/data/commentColumns'
    ...
    const [registerDefaultConfig, { getFieldsValue }] = createFormRegisterInstance({
      ...
      baseColProps: { span: 10 }, // 配置所有选子项的 ColProps，不需要逐个配置，子项也可单独配置优先与全局
