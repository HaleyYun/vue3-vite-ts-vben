<template>
  <div style="background-color: white">
    <EraSwitchTable change-space="special">
      <template #tableEdit>
        <a-button type="primary" class="submit-btn" @click="releaseQuest()">布问题</a-button>
      </template>
      <template #content>
        <Table
          :columns="columns"
...
<script lang="ts">
  ...
  import {
    containerConfig
  } from "/@/modules/ContentModule/view/CircleManage/ProblemManage/data/ProblemListContainerData";
  interface FormState {
    column: string
    category: string
    project: string
  ...
  const columns = containerConfig.tableColumns
