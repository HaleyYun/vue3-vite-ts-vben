<template>
  <div class="order-list">
    <Card :bordered="false" class="w-full" title="订单统计">
      <div class="list-content">
        <!-- <template v-for="(item, index) in growQuickList" :key="index">
		  <div class="quickList">
			<img :src="item.img" alt="" style="width: 50px; height: 50px; margin-bottom: 15px" />
			<p>{{ item.title }}</p>
		  </div>
		</template> -->
        <p>占位</p>
