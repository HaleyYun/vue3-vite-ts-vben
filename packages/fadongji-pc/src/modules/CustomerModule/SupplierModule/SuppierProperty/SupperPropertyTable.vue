...
<script lang="ts">
  ...
  // “供应商资产” - table 数据集
  import { propertyTableData } from '/@/modules/CustomerModule/SupplierModule/SuppierProperty/mock'
  // “供应商资产” - table Column数据项
  import { supperPropertyColumn } from '/@/modules/CustomerModule/SupplierModule/SuppierProperty/type/type'
