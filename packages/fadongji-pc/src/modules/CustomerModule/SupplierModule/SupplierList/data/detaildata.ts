...
export const filterEmploymentPageForm: DescItem[] = [
    {
        field: 'corpType',
        label: '企业类型',
        labelMinWidth:120
...
export const financialDesc: DescItem[] = [
    {
        field: 'parenBankName',
        label: '对公账户银行',
        labelMinWidth:120
