...
<script lang="ts">
  ...
  import {
    filterGarageAssetsForm,
    GarageAssetsColumn,
  } from '/@/modules/CustomerModule/Garage/view/GarageAssets/data/GarageAssetsData'
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const [registerForm] = useForm({
        labelWidth: 120,
        schemas: filterGarageAssetsForm,
      })
      ...
      const handleFilterTable = async (values) => {
        ...
        GarageCancellModel.subjectPhone = values.subjectPhone
      ...
      const initCompanyInfoGarageTabData = async () => {
        ...
        try {
          ...
          const { data } = await adminHttp.CUSTOMER.companyInfoGarageAssetPage(filterParams)
