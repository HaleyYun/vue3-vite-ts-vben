...
<script setup lang="ts">
  ...
  import { alreadyFormSchemas } from '../data/configuration'
  ...
  const [registerDefaultConfig, { getFieldsValue }] = createFormRegisterInstance({
    ...
    fieldMapToTime: [['searchTime', ['startBillTime', 'endBillTime'], 'YYYY-MM-DD']], // 用于将表单内时间区域的应设成 2 个字段
