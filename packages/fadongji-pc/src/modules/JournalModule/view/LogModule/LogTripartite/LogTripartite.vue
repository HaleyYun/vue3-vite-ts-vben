          ...
          <template #tableEdit>
            <div class="flex" style="align-items: center">
              <a-form layout="inline">
                <AFormItem label="清除日志" :label-col="{ span: 13 }" :wrapperCol="{ span: 14 }">
...
<script setup lang="ts">
  ...
  import TripartiteFilterForm from '/@/modules/JournalModule/view/LogModule/LogTripartite/component/TripartiteFilterForm.vue'
  ...
  import { containerConfig } from '/@/modules/JournalModule/view/LogModule/LogTripartite/data/TripartiteContainerData'
