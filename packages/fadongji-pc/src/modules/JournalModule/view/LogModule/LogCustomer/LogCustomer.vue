...
<script setup lang="ts">
  ...
  import CustomerFilterForm from '/@/modules/JournalModule/view/LogModule/LogCustomer/component/CustomerFilterForm.vue'
  ...
  import { containerConfig } from '/@/modules/JournalModule/view/LogModule/LogCustomer/data/CustomerContainerData'
