                      ...
                      <tbody>
                        <div class="body_top_con">
                          <div class="top_con_shop">
                            <span class="top_con_num ml-4 margin-r-20">订单号：{{ item.id }}</span>
                          ...
                          <tbody>
                            <tr class="body_content">
                              ...
                              >
                                ...
                                <!--status	integer-->
                                <!--非必须-->
                                <!--订单状态，2110：待审核，2120：待发货，2140：待签收，2130:待退款,2150:已完成,2160:已关闭 0全部-->
                              </td>
                              <td
                                colspan=""
                                :rowspan="1"
                              ...
                              >
                                <div class="flex" style="flex-direction: column">
                                  ...
                                  >
                                    <AButton type="link">手动退款 </AButton>
                                  </APopconfirm>
                                </div>
                              </td>
                            </tr>
...
<script setup lang="ts">
  ...
  import { reactive, ref, watch, createVNode, onBeforeMount } from 'vue'
  import EraTableTitle from '/@/components/EraTableTitle/EraTableTitle.vue'
  import { ExclamationCircleOutlined } from '@ant-design/icons-vue'
  import { Modal } from 'ant-design-vue'
  import EraProForm from '/@/components/EraProForm/EraProForm.vue'
  import AgentAfterFilterForm from '/@/modules/OrderModule/view/AgentOrder/AgentAfterSalesOrder/component/AgentAfterFilterForm.vue'
  ...
  import { containerConfig } from '/@/modules/OrderModule/view/AgentOrder/AgentAfterSalesOrder/data/AgentAfterContainerData'
  ...
  const handlerStatus = async () => {
    const { data } = await adminHttp.Order.orderRefundQueryAmount({ type: 2, status: 0 })
    tabsList.value = [
