...
script.__file = 'packages/components/WangEditor/src/WangEditor.vue'

const VocenWangEditor = withInstall(script)

export default VocenWangEditor
export { VocenWangEditor }
